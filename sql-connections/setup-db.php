...
<div style=" margin-top:10px;color:#FFF; font-size:23px; text-align:left">
    <font size="3" color="#FFFF00">
        ...
        if (mysql_query($sql)) {
            ...
            echo "[*]...................Error purging database: " . mysql_error();
            echo "<br><br>\n";
        }
        ...
        # 判断全局变量 GZCTF_FLAG 是否存在，不存在则设为默认值
        $GZCTF_FLAG = getenv('GZCTF_FLAG');
        if ($GZCTF_FLAG === false) {
            echo "[*]...................GZCTF_FLAG not found, set default value";
            echo "<br><br>\n";
            $GZCTF_FLAG = 'cssec{this_is_a_sample_flag}';
        } else {
            echo "[*]...................GZCTF_FLAG set successful!";
            echo "<br><br>\n";
        }

        // 创建 flag 表
        $sql = "CREATE TABLE security.flag (flag varchar(100) NOT NULL)";
        if (mysql_query($sql)) {
            echo "[*]...................Creating New Table 'FLAG' successfully";
            echo "<br><br>\n";
        } else {
            echo "[*]...................Error creating Table: " . mysql_error();
            echo "<br><br>\n";
        ...
        // 注入 flag
        $sql = "INSERT INTO security.flag (flag) VALUES ('$GZCTF_FLAG')";
        if (mysql_query($sql)) {
            echo "[*]...................Inserted data correctly  into table 'FLAG'";
            echo "<br><br>\n";
        } else {
            echo "[*]...................Error inserting data: " . mysql_error();
            echo "<br><br>\n";
